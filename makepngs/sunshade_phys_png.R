...
###Photosynthesis vs gs (need to fit sun with something else)------------------------------------------------
  ...
  plot(Photo~Cond, data=gm_c13, subset=leaflight=="sun-high", pch=16, col=suncol, ylim=c(0,25), 
       xlim=c(0,.4), xlab=condlab, ylab="", cex=1.5)
  ...
  title(ylab=satlab, mgp=ypos, cex=1.25)
...
##bootstrap plots of confidence intervals with chamber as random effect---------------------------------
  ...
  par(mar=c(5,5,2,2), cex.lab=1.25)
  plot(Photo~Cc, data=sundat, pch=16, col=suncol, ylim=c(0,25), xlim=c(0,350), xlab=cclab, ylab="", cex=1.5)
...
par(mar=c(5,5,2,2), cex.lab=1.25)
plot(Photo~Ci, data=sundat, pch=16, col=suncol, ylim=c(0,25), xlim=c(0,350), xlab=cilab, ylab="", cex=1.5)
...
Agm_sha_lm <- lmer(Photo~ gm + (1|chamber), data=agm_sha)
  ...
  par(mar=c(5,5,2,2), cex.lab=1.25)
plot(Photo~gm, data=sundat, pch=16, col=suncol, ylim=c(0,25), xlim=c(0,.5), xlab=gmlab, ylab="", cex=1.5)
...
plot(Photo~ci_bar, data=sundat, pch=16, col=suncol, ylim=c(0,25), 
     xlim=c(150,350), xlab=cibarlab2, ylab="", cex=1.5)
#shade
...
###try with gam
  ...
  plot(Photo~gmgs, data=gm_c13, subset=leaflight=="sun-high", pch=16, col=suncol, ylim=c(0,25), 
       xlim=c(0,.6), xlab=condlab, ylab="", cex=1.5)
