...
png(filename = "makepngs/ciccbar.png", width = 11, height = 8.5, units = "in", res= 400)

par(mfrow=c(1,3))

bar(Ci, leaflight, gasex_agg, col=cols, half.errbar=FALSE, ylim=c(0, 325),names.arg=FALSE,xlab="",
    mar=c(5,6,2,1), ylab=cilab, cex.axis=1.75, cex.lab = 2.25,legend=F)
abline(v=2.5, lty=5)
...
bar(Cc, leaflight, gasex_agg, col=cols, xlab="", half.errbar=FALSE, ylim=c(0, 325),names.arg=FALSE,
    mar=c(5,6,2,1), ylab=cclab,   cex.axis=1.75, cex.lab = 2.25, legend=F)
abline(v=2.5, lty=5)
...
bar(drawdown, leaflight, gasex_agg, col=cols, xlab="", half.errbar=FALSE, ylim=c(0, 110),names.arg=FALSE,
    mar=c(5,6,2,2), ylab=drawdownlab,   cex.axis=1.75, cex.lab = 2.25, legend=F)
abline(v=2.5, lty=5)
