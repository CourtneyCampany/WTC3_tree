...
\
*Response*: If the cost of water (sensu Cowan & Farquhar 1977) is constant throughout the canopy, then we would expect similar WUE in sun and shade leaves. Since we found that shade leaves have lower WUE, this could indicate a lower cost of water. This is consistent with the observation that hydraulic conductance was higher in shade leaves. We have expanded the section (previously lines 431-434) to read:
