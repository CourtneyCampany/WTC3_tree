...
\
Bulk-leaf $\delta$^13^C, as an index of integrated water-use efficiency [@marshall2007sources], was significantly lower in shade leaves compared to sun leaves by ca. 2&permil; (Table `r wtc3tab1`). No effects of the warming treatment on leaf $\delta$^13^C were detected. Leaf $\delta$^13^C and N~area~ were positively correlated for all leaves (P<0.001, Figure `r waterusefig`b), with less negative $\delta$^13^C (higher water-use efficiency) and higher N investment in sun leaves.
