...
Mean g~s~ was significantly higher in shade compared to sun leaves (+18%) under their local light environment (P = 0.004). Increases in g~s~ were positively correlated to increases in A in sun leaves, however, g~s~ and A were not correlated in shade leaves under low light (Figure `r agmgsfig`a). Following an increase in available light, g~s~ of shade leaves was significantly greater than both shade leaves at low light and sun leaves ( Figure `r gebarfig`a). With increased light availability, increases in A and g~s~ in shade leaves exhibited similar behavior as observed in sun leaves.
