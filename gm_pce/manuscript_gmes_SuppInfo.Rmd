...
```{r airvars, fig.width=7, fig.height=8.8, echo=FALSE,warning=FALSE,dev="png", dpi=600,  eval=includeFigs, dev.args=list(type="cairo")}
...
\
```{r deltacica, fig.width=6, fig.height=6, echo=FALSE,warning=FALSE,dev="png", dpi=600, eval=includeFigs, dev.args=list(type="cairo")}
...
\
```{r gasex_temp3, fig.width=7, fig.height=9, echo=FALSE,warning=FALSE,dev="png", dpi=600, dev.args=list(type="cairo"), eval=includeFigs}
...
\
```{r gasex_temp4, fig.width=7, fig.height=9, echo=FALSE,warning=FALSE,dev="png", dpi=600, dev.args=list(type="cairo"), eval=includeFigs}
