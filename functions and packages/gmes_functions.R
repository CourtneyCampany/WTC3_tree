...
####gmescalculation with discrimination contributions----------------------------------------------------------------------------
gmcalc_func2 <- function(x, a=4.4, ab= 2.9, e=30, b=29, f=16.2,del_growth = -8 , delR=-38, 
                         k25r=0.728, k25g=38.89, Ea_r = 72.311, Ea_g = 20.437,Rgc=8.314472){
  ...
  #add mesophyll resistance to more easily examine bad data
  x$rm_resist <- 1/x$gm
